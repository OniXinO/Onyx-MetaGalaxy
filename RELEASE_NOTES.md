...
- Профілі OPM-only:
  ...
  - `opm_superquality` — максимум якості/ефектів для топ систем.
...
## Відомі питання
- Увімкнення складних графічних модів у `opm_quality/opm_superquality` може вимагати тонкого тюнінгу (налаштування PostProcessing/Scatterer/EVE), що не входить до цього релізу.
